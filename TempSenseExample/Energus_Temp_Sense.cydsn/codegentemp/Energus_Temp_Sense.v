// ======================================================================
// Energus_Temp_Sense.v generated from TopDesign.cysch
// 11/10/2016 at 11:52
...
// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=11368422, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=true, Sample_Precharge=6, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_1:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=ADC_SAR_Seq_1_SAR, )
module ADC_SAR_v3_0_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("52ff75f5-c632-46f7-afe7-66aeddccc49d/dea208d9-07b0-438b-a5e0-ac5d207f2658/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// ADC_SAR_SEQ_v2_0(ADC_Clock_Frequency=1800000, Adjust=0, ClockSource=0, InputRange=1, NumChannels=2, Reference=1, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=6, SampleRate=100000, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_Seq_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=ADC_SAR_Seq_1, )
module ADC_SAR_SEQ_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("52ff75f5-c632-46f7-afe7-66aeddccc49d/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("52ff75f5-c632-46f7-afe7-66aeddccc49d/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a500342f-7e2b-4251-85c6-cf10484ece88"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 V_2 (
        .connect({
            Net_735,
            Net_732
        })
    );
    defparam V_2.comp_name = "VSource_v1_0";
    defparam V_2.port_names = "N, P";
    defparam V_2.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("b5b6c380-8b64-4313-a86d-d37c3ca78bb9"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
