...
*
*  Vhi_DM_STRONG     Strong Drive 
*  Vhi_DM_OD_HI      Open Drain, Drives High 
*  Vhi_DM_OD_LO      Open Drain, Drives Low 
*  Vhi_DM_RES_UP     Resistive Pull Up 
*  Vhi_DM_RES_DWN    Resistive Pull Down 
*  Vhi_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Vhi_DM_DIG_HIZ    High Impedance Digital 
*  Vhi_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
