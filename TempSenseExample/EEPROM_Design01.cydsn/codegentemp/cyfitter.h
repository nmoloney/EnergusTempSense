...
/* LED_BUSY */
#define LED_BUSY__0__INTTYPE CYREG_PICU0_INTTYPE0
#define LED_BUSY__0__MASK 0x01u
#define LED_BUSY__0__PC CYREG_PRT0_PC0
#define LED_BUSY__0__PORT 0u
#define LED_BUSY__0__SHIFT 0
#define LED_BUSY__AG CYREG_PRT0_AG
#define LED_BUSY__AMUX CYREG_PRT0_AMUX
#define LED_BUSY__BIE CYREG_PRT0_BIE
#define LED_BUSY__BIT_MASK CYREG_PRT0_BIT_MASK
#define LED_BUSY__BYP CYREG_PRT0_BYP
#define LED_BUSY__CTL CYREG_PRT0_CTL
#define LED_BUSY__DM0 CYREG_PRT0_DM0
#define LED_BUSY__DM1 CYREG_PRT0_DM1
#define LED_BUSY__DM2 CYREG_PRT0_DM2
#define LED_BUSY__DR CYREG_PRT0_DR
#define LED_BUSY__INP_DIS CYREG_PRT0_INP_DIS
#define LED_BUSY__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define LED_BUSY__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define LED_BUSY__LCD_EN CYREG_PRT0_LCD_EN
#define LED_BUSY__MASK 0x01u
#define LED_BUSY__PORT 0u
#define LED_BUSY__PRT CYREG_PRT0_PRT
#define LED_BUSY__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define LED_BUSY__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define LED_BUSY__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define LED_BUSY__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define LED_BUSY__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define LED_BUSY__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define LED_BUSY__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define LED_BUSY__PS CYREG_PRT0_PS
#define LED_BUSY__SHIFT 0
#define LED_BUSY__SLW CYREG_PRT0_SLW

/* Reset_CNT */
#define Reset_CNT__0__INTTYPE CYREG_PICU0_INTTYPE2
#define Reset_CNT__0__MASK 0x04u
#define Reset_CNT__0__PC CYREG_PRT0_PC2
#define Reset_CNT__0__PORT 0u
#define Reset_CNT__0__SHIFT 2
#define Reset_CNT__AG CYREG_PRT0_AG
#define Reset_CNT__AMUX CYREG_PRT0_AMUX
#define Reset_CNT__BIE CYREG_PRT0_BIE
#define Reset_CNT__BIT_MASK CYREG_PRT0_BIT_MASK
#define Reset_CNT__BYP CYREG_PRT0_BYP
#define Reset_CNT__CTL CYREG_PRT0_CTL
#define Reset_CNT__DM0 CYREG_PRT0_DM0
#define Reset_CNT__DM1 CYREG_PRT0_DM1
#define Reset_CNT__DM2 CYREG_PRT0_DM2
#define Reset_CNT__DR CYREG_PRT0_DR
#define Reset_CNT__INP_DIS CYREG_PRT0_INP_DIS
#define Reset_CNT__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Reset_CNT__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Reset_CNT__LCD_EN CYREG_PRT0_LCD_EN
#define Reset_CNT__MASK 0x04u
#define Reset_CNT__PORT 0u
#define Reset_CNT__PRT CYREG_PRT0_PRT
#define Reset_CNT__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Reset_CNT__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Reset_CNT__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Reset_CNT__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Reset_CNT__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Reset_CNT__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Reset_CNT__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Reset_CNT__PS CYREG_PRT0_PS
#define Reset_CNT__SHIFT 2
#define Reset_CNT__SLW CYREG_PRT0_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "EEPROM_Design01"
