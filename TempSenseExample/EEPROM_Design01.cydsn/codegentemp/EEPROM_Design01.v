...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c63a1994-5731-43fb-87ff-1994289db66d/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__LED_BUSY_net;
	wire [0:0] tmpFB_0__LED_BUSY_net;
	wire [0:0] tmpIO_0__LED_BUSY_net;
	wire [0:0] tmpINTERRUPT_0__LED_BUSY_net;
	electrical [0:0] tmpSIOVREF__LED_BUSY_net;
	...
	cy_psoc3_pins_v1_10
		...
		LED_BUSY
		 (.oe(tmpOE__LED_BUSY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_BUSY_net[0:0]}),
		  .io({tmpIO_0__LED_BUSY_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_BUSY_net),
		  .interrupt({tmpINTERRUPT_0__LED_BUSY_net[0:0]}),
		  .annotation({Net_73}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_BUSY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Reset_CNT_net;
	wire [0:0] tmpFB_0__Reset_CNT_net;
	wire [0:0] tmpIO_0__Reset_CNT_net;
	wire [0:0] tmpINTERRUPT_0__Reset_CNT_net;
	electrical [0:0] tmpSIOVREF__Reset_CNT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Reset_CNT
		 (.oe(tmpOE__Reset_CNT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Reset_CNT_net[0:0]}),
		  .io({tmpIO_0__Reset_CNT_net[0:0]}),
		  .siovref(tmpSIOVREF__Reset_CNT_net),
		  .interrupt({tmpINTERRUPT_0__Reset_CNT_net[0:0]}),
		  .annotation({Net_80}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Reset_CNT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("eff31bd3-85f3-4a7e-bc2d-9a073ac03a20"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 R24 (
        .connect({
            Net_68,
            Net_72
        })
    );
    defparam R24.comp_name = "Resistor_v1_0";
    defparam R24.port_names = "T1, T2";
    defparam R24.width = 2;
    ...
    cy_annotation_universal_v1_0 R21 (
        .connect({
            Net_77,
            Net_72
        })
    );
    defparam R21.comp_name = "Resistor_v1_0";
    defparam R21.port_names = "T1, T2";
    defparam R21.width = 2;
